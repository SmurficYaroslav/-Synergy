...
class Main(tkinter.Frame):
    ...
    def init_main(self):
        ...
        self.ADDIMG = tkinter.PhotoImage(file=r"C:\Users\yaroslav\Downloads\Итоговый проект всё\Итоговый проект/img/add.png")
        # Создание кнопки add.
        ...
        self.DELETEIMG = tkinter.PhotoImage (file=r"C:\Users\yaroslav\Downloads\Итоговый проект всё\Итоговый проект\img/delete.png")
        ...
        self.REDACTIMG = tkinter.PhotoImage(file=r"C:\Users\yaroslav\Downloads\Итоговый проект всё\Итоговый проект\img/redact.png")
        ...
        self.SEARCHIMG = tkinter.PhotoImage(file=r"C:\Users\yaroslav\Downloads\Итоговый проект всё\Итоговый проект\img/search.png")
        ...
        self.REFRESHIMG = tkinter.PhotoImage(file=r"C:\Users\yaroslav\Downloads\Итоговый проект всё\Итоговый проект\img/refresh.png")
